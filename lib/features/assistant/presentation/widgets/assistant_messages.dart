...
/// Opens the full chat history sheet (loads messages first).
Future<void> showAssistantMessagesSheet(BuildContext context) async {
  await context.read<AssistantCubit>().loadMessages();
